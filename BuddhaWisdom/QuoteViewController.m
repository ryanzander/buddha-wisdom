...
- (void)viewDidLoad {
    ...
    // Bool will be set to YES the first time the share buton is pressed
...
- (IBAction)shareTouched:(id)sender {
    ...
    if (knowsTip == NO) {
        ...
        // first time user taps share button, we'll show a popup so they know they need to copy and paste for facebook
        ...
        // set the bool to YES and save in user defaults
        knowsTip = YES;
